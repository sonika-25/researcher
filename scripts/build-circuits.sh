...
if [ -f ./powersOfTau28_hez_final_14.ptau ]; then
    ...
    curl https://hermez.s3-eu-west-1.amazonaws.com/powersOfTau28_hez_final_14.ptau --output powersOfTau28_hez_final_14.ptau
fi
...
cp verifier.sol ../contracts/semaphore/Verifier.sol
